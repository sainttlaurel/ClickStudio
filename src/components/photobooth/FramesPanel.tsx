...
const getFramePreviewStyle = (frameId: string) => {
  switch (frameId) {
    ...
    case 'film':
      return { border: '4px solid #1f2937', borderRadius: '4px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }
    case 'blush':
      return { border: '8px solid #fce7f3', borderRadius: '12px' }
    case 'minimal':
      return { border: '1px solid #d1d5db', borderRadius: '2px' }
    case 'polaroid':
      return { border: '12px solid #ffffff', borderRadius: '4px', boxShadow: '0 4px 8px rgba(0,0,0,0.15)' }
    default:
      return { border: '2px solid #e5e7eb', borderRadius: '8px' }
  }
}
